...
this.processSlide = function(value) {
  ...
  if (this.index === this.slides.length - 1) {
    ...
    Traitify.addSlides(that.assessmentId, slides).then(function(response) {
      return that.onFinished(that);
    });
