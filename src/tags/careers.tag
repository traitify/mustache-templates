<tf-careers>
  ...
  <style>
    ...
    .tf-careers .tf-experience-filters{
      text-align: right;
      border-radius: 3px;
      overflow: hidden;
    }
    .tf-careers .tf-experience-filters div{
      display: inline-block;
      font-weight: 600;
      font-size: 14px;
      line-height: 18px;
    }
    .tf-careers .tf-experience-filters .tf-filter-header{
      margin-right: 10px;
    }
    .tf-careers .tf-experience-filters .tf-experience-filter{
      padding: 5px 12px;
      background-color: #00aeef;
      cursor: pointer;
      color: #fff;
    }
    .tf-careers .tf-experience-filters .tf-highlight-filter{
    ...
    .tf-careers .tf-career-details  hr{
      border: none;
    ...
    .tf-careers .tf-career-details  .tf-image{
      width: 100%;
      top: 10px;
      margin: 0px auto;
    }
    .tf-careers .tf-career-details  .tf-title{
      margin: 10px;
      margin-bottom: 0px;
      font-weight: 600;
    }
    .tf-careers .tf-career-details  .tf-description{
      margin-top: 5px;
      font-weight: 400;
    }
    .tf-careers .tf-career-details  .tf-description,
    .tf-careers .tf-career-details  .tf-experience-boxes{
      padding: 0px 10px 5px;
    }

    .tf-careers .tf-career-details  .tf-experience,
    .tf-careers .tf-career-details  .tf-education,
    .tf-careers .tf-career-details  .tf-match-rate{
      display: block;
      color: #2e2e2e;
      font-weight: 400;
      font-size: 16px;
    ...
    .tf-careers .tf-career-details  .tf-score{
      margin: 10px;
    }
    .tf-careers .tf-career-details  .tf-match-rate .tf-percent{
      display: inline-block;
      float: right;
      text-align:right;
    }

    .tf-careers .tf-career-details  .tf-experience-box{
    ...
    .tf-careers .tf-career-details  .tf-experience-box.tf-highlighted-box{
      background-color: #00aeef;
    }
    .tf-careers .tf-career-details  .tf-education-text{
      margin: 5px 10px;
      font-size: 14px;
      color: #4e4e4e;
      font-weight: 300;
    }
    .tf-careers .tf-career-details  .tf-fade{
      position: relative;
      height: 4.3em;
      overflow: hidden;
    }
    .tf-careers .tf-career-details  .tf-fade:after {
      content: "";
      text-align: right;
      position: absolute;
      bottom: 0;
    ...
    .tf-careers .tf-career-details.tf-show-details:hover {
      cursor: pointer;
    }
    .tf-clearfix{
      clear:both;
